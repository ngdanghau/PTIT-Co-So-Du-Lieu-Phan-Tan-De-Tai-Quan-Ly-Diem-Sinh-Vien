...
{
    public partial class InDSSV_RP : DevExpress.XtraReports.UI.XtraReport
    {
        public InDSSV_RP(string nienkhoa, int hocky, string mamh, int nhom, string Khoa, string tenmh)
        {
            InitializeComponent();
